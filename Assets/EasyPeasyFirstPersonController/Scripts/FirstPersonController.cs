namespace EasyPeasyFirstPersonController
{
    ...
    public partial class FirstPersonController : MonoBehaviour
    {
        ...
        [Range(-90f, 0f)] public float minLookAngle = -55f;
        [Range(0f, 90f)] public float maxLookAngle = 70f;
        ...
        private void Update()
        {
            ...
            if (isLook)
            {
                ...
                // Límite de rotación vertical
                rotY = Mathf.Clamp(rotY, minLookAngle, maxLookAngle);
        ...
        private void HandleMovement()
        {
            ...
            if (animator != null)
            {
                bool isWalking = moveInput.magnitude > 0.1f && isGrounded && !isSliding;
